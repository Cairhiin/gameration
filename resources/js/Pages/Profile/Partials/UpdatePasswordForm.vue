    ...
    <FormSection @submitted="updatePassword">
        ...
        <template #form>
            <div class="col-span-6 sm:col-span-4">
                ...
                <FormInput id="current_password" ref="currentPasswordInput" v-model="form.current_password"
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <FormInput id="password" ref="passwordInput" v-model="form.password" type="password"
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <FormInput id="password_confirmation" v-model="form.password_confirmation" type="password"
                    class="mt-1 block w-full" autocomplete="new-password" />
