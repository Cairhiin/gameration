...
<template>
    <ActionSection>
        ...
        <template #content>
            <h3 v-if="twoFactorEnabled && !confirming" class="text-lg font-medium text-light">
                You have enabled two factor authentication.
            </h3>

            <h3 v-else-if="twoFactorEnabled && confirming" class="text-lg font-medium text-light">
                Finish enabling two factor authentication.
            </h3>

            <h3 v-else class="text-lg font-medium text-light">
                You have not enabled two factor authentication.
            </h3>

            <div class="mt-3 max-w-xl text-sm text-lightVariant">
                <p>
            ...
            <div v-if="twoFactorEnabled">
                <div v-if="qrCode">
                    <div class="mt-4 max-w-xl text-sm text-lightVariant">
                    ...
                    <div class="mt-4 p-2 inline-block bg-dark/60" v-html="qrCode" />

                    <div v-if="setupKey" class="mt-4 max-w-xl text-sm text-lightVariant">
                    ...
                    <div v-if="confirming" class="mt-4">
                        ...
                        <FormInput id="code" v-model="confirmationForm.code" type="text" name="code"
